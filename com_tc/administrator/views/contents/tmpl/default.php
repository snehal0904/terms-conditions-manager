...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tc&task=contents.saveOrderAjax&tmpl=component';
			...
			<table class="table table-striped" id="contentList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_TC_CONTENTS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_tc&task=content.edit&id='.(int) $item->id); ?>">
