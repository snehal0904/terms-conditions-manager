...
$document->addStyleSheet(JUri::root() . 'administrator/components/com_tc/assets/css/tc.css');
$document->addStyleSheet(JUri::root() . 'media/com_tc/css/list.css');

$user      = JFactory::getUser();
$userId    = $user->get('id');
$listOrder = $this->state->get('list.ordering');
$listDirn  = $this->state->get('list.direction');
$canOrder  = $user->authorise('core.edit.state', 'com_tc');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tc&task=usertcs.saveOrderAjax&tmpl=component';
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="contentList">
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_TC_USERTCS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'usertcs.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'usertcs.', $canCheckin); ?>
				<?php endif; ?>
